...
from DevBot.__help__ import STATS, USER_INFO
import DevBot.Database.userinfo_sql as sql
from DevBot.Plugins.disable import DisableAbleCommandHandler
from DevBot.Database.global_bans_sql import is_user_gbanned
from DevBot.Database.afk_sql import is_afk, check_afk_status
from DevBot.Database.users_sql import get_user_num_chats
from DevBot.Handlers.validation import sudo_plus, user_admin, support_plus
from DevBot.Handlers.extraction import extract_user
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n┣|• This user is member of 'DevBot Developer Team'."
        disaster_level_present = True
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/DevBot_Updates">?</a>]'.format(
            bot.username
        )
...
*What is that health thingy?*
 Come and see [HP System explained](https://t.me/DevBot_Updates)
"""
__mod_name__ = "Infos"
