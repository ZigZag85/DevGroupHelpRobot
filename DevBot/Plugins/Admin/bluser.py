...
import html
import DevBot.Database.blacklistusers_sql as sql
from DevBot import (
    DEV_USERS,
    OWNER_ID,
    INSPECTOR,
...
from DevBot.Handlers.validation import dev_plus
from DevBot.Handlers.extraction import (
    extract_user,
    extract_user_and_text,
)
from DevBot.Plugins.Admin.log_channel import gloggable
from telegram import ParseMode, Update
from telegram.error import BadRequest
from telegram.ext import CallbackContext, CommandHandler, run_async
from telegram.utils.helpers import mention_html

BLACKLISTWHITELIST = DEV_USERS.union(INSPECTOR).union(REQUESTER).add(OWNER_ID)
BLABLEUSERS = DEV_USERS.add(OWNER_ID)
