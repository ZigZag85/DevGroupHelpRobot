...
import DevBot.Database.notes_sql as sql
from DevBot import LOGGER, JOIN_LOGGER, SUPPORT_CHAT, dispatcher, INSPECTOR
from DevBot.Plugins.disable import DisableAbleCommandHandler
from DevBot.Handlers.managers import MessageHandlerChecker
from DevBot.Handlers.validation import user_admin, connection_status
from DevBot.Handlers.misc import build_keyboard, revert_buttons
from DevBot.Handlers.msg_types import get_note_type
...
def __stats__():
    return f"• {sql.num_notes()} notes in {sql.num_chats()} groups."
