...
import DevBot.Database.connection_sql as sql
from DevBot import dispatcher, INSPECTOR, DEV_USERS
from DevBot.Handlers import validation
...
__help__ = """
Sometimes, you just want to add some notes and filters to a group chat, but you don't want everDevBot to see; This is where connections come in...
