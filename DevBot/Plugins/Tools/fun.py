...
import DevBot.Plugins.Tools.fun_strings as fun_strings
from DevBot import dispatcher
...
def pat(update: Update, context: CallbackContext):
    ...
    if pat_type == "Text":
        ...
        reply_to.reply_text(html.escape(reply), parse_mode=ParseMode.HTML)
