RUN_STRINGS = (
    ...
    "Run everDevBot, they just dropped a bomb 💣💣",
...
SLAP_TEMPLATES = (
    ...
    "{user2} turned the tables on {user1} and counter slapped.",
    "{user1} tried the slap command. Nothing happened.",
    "{user2} died and went to heaven. {user1} lived but went to jail.",
    "{user1} Framed {user2} for a crime they didn’t commit.",
    "Puri Puri Prisoner hugged {user2}", #ONEPUNCHMAN
    "Lelouch Vi Britania Orders {user2} to die.", #Code Geass
    "{user2} gets to choose their first pokemon.. but there were only Magikarps.", #Pokemon
    "{user2} causes {user1} to activate their Trap card.", #Yugioh
)
