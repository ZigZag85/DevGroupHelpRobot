import importlib, re
from DevBot import dispatcher, ALLOW_EXCL, LOGGER
from telegram import InlineKeyboardButton, InlineKeyboardMarkup, ParseMode, Update
from DevBot.Handlers.misc import paginate_modules
